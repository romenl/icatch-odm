...
curryCMD( 'GetVideoEncoderConfigurations', async (arg) => {
    ...
    return {
        ...
        CBR: configuration.RateControl.ConstantBitRate.v,
...
export const GetAnalyticsConfigurations =
curryCMD( 'GetAnalyticsConfigurations', async (arg) => {
    let token = arg[0];
    let res = await onvifCMD( 'media2', 'GetAnalyticsConfigurations', token );
    console.log(res);
